...
- poprawic program: dodac opis i brak polaczenia z comem, zapis danych w pliku ini (zakladka z ostatio urzywanymi) i wyzarzanie starych komunikatow
EWR:
...
- antasten poprawic oraz wysylanie numeru artykulu i numeru seryjnego
