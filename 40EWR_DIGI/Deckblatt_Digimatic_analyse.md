...
| **Geraet**                | T1 [ms] | T2 [ms] | T3 [ms] | T4 [us] | T6 [us] | T7 [us] | bemerkungen        |  |
| ------------------------- | ------- | ------- | ------- | ------- | ------- | ------- | ------------------ |![Image][1]|
| min                       | 2       | -       | -       | -       | -       | -       |                    |
...
| **Micromar 40EWR**        | 0,6     | 21      | 105     | 110     | 1200    | 13      | unter 1 s unstabil |
| **Micromar 40EWR-L**      | 0,8     | 21      | 104     | 108     | 1200    | 13      | unter 1 s unstabil |
...
[2]: Micromar_40EWR/device.png
[3]: Micromar_40EWR/device.png
[4]: Micromar_40EWR/device.png
[5]: Micromar_40EWR/device.png
