...
|-|-|-|-|-|-|-|
|1|![image](img/NEO_LTS_1.png)|NEO LTS|von selbem Hersteller wie NEO3, klein, guenstig, mit Geheuse |ca 30 euro|gross|[nanopi NEO-LTS](https://www.friendlyelec.com/index.php?route=product/product&path=69&product_id=132)|
|-|![image](/img/NEO_DISPL.png)|NEO Dispaly|||gross|[display](https://www.friendlyelec.com/index.php?route=product/product&product_id=191)|
|-|![[Pasted image 20221103154938.png]]|NEO LTS + Display + Metal Gehause||ca 50 euro|gross|[nanopi mit display und metal gehause](https://www.friendlyelec.com/index.php?route=product/product&product_id=190)|
|1|![[rpi3bp.png]]|Raspberry Pi | bekannst und guenstig| <100 eur| problematisch|[raspberry Pi 3, Model B+](https://www.raspberrypi.com/products/raspberry-pi-3-model-b/)|
|-|![image](/img/rpi3bp_metal.png)|Raspberry pi with Metal housing|||probleme mi|[Metallgehäuse Raspberry Pi 3 - schwarz](https://de.farnell.com/gothenburg-designs/110218b/metal-case-for-raspberry-pi-3/dp/3404375?ost=110218b)|
|2|![image](/img/rpizerow.png)| Raspberry pi zero W ||||[raspberry pi zero w]([Raspberry Pi Zero 2 W – Raspberry Pi](https://www.raspberrypi.com/products/raspberry-pi-zero-2-w/))|
...
|4|![[up-core_1.png]]|Intel (x86) Single Board Computer (SBC), kleinest| komplexe anvendung moeglich, mit database, www-server, kommunikation mit mehrere geraete, fortgeschrittene Algoritmen, EDGE computing, AI, ML...  ||>100eur|[up-core](https://up-board.org/upcore/specifications/)   [up-board, all](https://up-board.org/boards/)|
