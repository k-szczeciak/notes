- (przystan szkraba)
- mail do englera w spawie it-seal 
- update TOLx setting up for large numbers  - works!!! (DK-U1 setting large values TOL, PRE dziala)
- niesymetrycnza tolerancja - sprawdzic - always symetrical
- wskazanie zakresu 1.0
- zakresy tolernacji dla incha dodac: 10, 11 i 12 (dodatkowe skale dla inch - wartosci):
...
- przelaczanie skali w tolerancji +/- 3 stany:
	- najpierw poszerzenie a potem zmniejszenie
	- jerzeli poszerzenie to wychodzi poza zakres
