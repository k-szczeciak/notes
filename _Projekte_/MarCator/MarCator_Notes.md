...
| 1  | Variante        | no value | GerĂ¤te-Variante: 1086R(i) oder 1087R(i) --> wird nicht verĂ¤ndert!                      |
|----|-----------------|----------|------------------------------------------------------------------------------------------|
| 2  | Einheit         | 1        | MaĂźeinheit  1: mm    2: inch                                                            |
| 3  | FixAufl         | no value | Fixe AuflĂ¶sung der Ziffernanzeige  --> wird nicht verĂ¤ndert!                           |
| 4  | Aufloesung      | 3        | AuflĂ¶sung der Ziffernanzeige (3: 000.0005 mm oder 00.00002 inch)                        |
| 5  | SkTeilung       | 3        | Skalenteilung 1..8 (entspricht der AuflĂ¶sung)                                           |
| 6  | Richtung        | 0        | ZĂ¤hlrichtung (hineingehend -> +)                                                        |
| 7  | FilterIx        | 2        | Filtereinstellung 0..4 -> RingbuffergrĂ¶Ăźe 1..16 Werte (Default: 4 Werte)               |
...
| 14 | TolAnz2000      | 0        | Anzeigeart der Tol-Ăśberschr. bei 2000:  0: mit Pfeil  1: mit Digitalanz.                |
| 15 | TaDelay         | 1        | TastenverzĂ¶gerung fĂĽr Data, Reset, Preset ...                                          |
| 16 | TouchSens       | 0        | Touchempfindlichkeit 0: ohne Handschuh, 1: mit Handschuh                                 |
| 17 | GeraeteNr       | 0        | GerĂ¤te-Nr. fĂĽr Funkverbindung                                                          |
| 18 | RFMode          | 1        |                                                                                          |
| 19 | RFFreqIx        | 0        | Index fĂĽr RFFreq-Array                                                                  |
| 20 | RFEcoMode       | 0        | Funk-Eco-Mode: 0: aus (Msg-Freq. 4Hz)   1: ein (Msg-Freq. 2Hz)                           |
| 21 | NoInch          | no value | 1: ohne Inch-Einstell-MenĂĽ      --> wird nicht verĂ¤ndert!                              |
...
| 24 | TeileNr[10]     | no value | Teile-Nr.                       --> wird nicht verĂ¤ndert!                               |
| 25 | SerienNr[10]    | no value | Serien-Nr.                      --> wird nicht verĂ¤ndert!                               |
| 26 | KalDatum[8]     | no value | Datum der letzten Kalibrierung  --> wird nicht verĂ¤ndert!                               |
| 27 | NextKalDatum[8] | no value | Datum der nĂ¤chsten Kalibrierung --> wird nicht verĂ¤ndert!                              |
| 28 | AnzFaktor       | 1.0      | Faktor fĂĽr angezeigten Wert                                                             |
| 29 | KorrFaktor      | no value | Faktor fĂĽr MaĂźstabskorrektur    --> wird nicht verĂ¤ndert!                             |
| 30 | MR_Offset       | 0        | Offset fĂĽr Messrichtungswechsel in 10 nm                                                |
...
| 50 | RFTestMenu      | 0        | 1: mit Funk-Test-MenĂĽ                                                                   |
| 51 | TolAussen[0]    | 0        | Toleranz-InnenAussen-Messung 0: Innen, 1: AuĂźen                                         |
| 52 | TolAussen[1]    | 0        | Toleranz-InnenAussen-Messung 0: Innen, 1: AuĂźen                                         |
| 53 | TolAussen[2]    | 0        | Toleranz-InnenAussen-Messung 0: Innen, 1: AuĂźen                                         |
| 54 | FctLock[0]      | 0        | Funktionssperre                                                                          |
| 55 | FctLock[1]      | 0        |                                                                                          |
| 56 | FctLock[2]      | 0        |                                                                                          |
| 57 | FctLock[3]      | 0        |                                                                                          |
| 58 | Clean           | 0        | CLEAN-Funktion                                                                           |
| 59 | PrIx            | 0        | Index fĂĽr Preset-Array                                                                  |
